...
export interface LoggerF {
  info(msg: string, className: string, methodName: string, level: LogLevelEnum, filename: string, type: LogTypeEnum.SERVICE): void;
  ...
  verbose(msg: string, className: string, methodName: string, level: LogLevelEnum.VERBOSE, type: LogTypeEnum.SERVICE): void;
  debug(msg: string, className: string, methodName: string, level: LogLevelEnum.DEBUG, type: LogTypeEnum.SERVICE): void;
  warn(msg: string, className: string, methodName: string, level: LogLevelEnum, filename: string, type: LogTypeEnum.SERVICE): void;
